...
declare enum RTCPeerConnectionState {
    /**
 ...
 */
declare enum RTCIceTcpCandidateType {
    /**
 ...
 */
declare enum RTCIceCandidateType {
    /**
     * A host candidate.
     */
    "host",
...
declare enum RTCDegradationPreference {
    /**
